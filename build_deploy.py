...
JP = os.path.join(LIB, 'javaparser-core-3.26.4.jar')
RELEASE = '17'
...
def main():
    ...
    print('=== 1) 编译 server ===')
    compile_mod('server', os.path.join(OUT, 'server', 'classes'), cp=H2 + os.pathsep + JP)
    ...
    shutil.copy2(JP, os.path.join(OUT, 'lib'))
    # demo 源码：服务端静态分析需要
